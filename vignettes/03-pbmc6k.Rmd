---
title: "Analysis of 10x PBMC 6k dataset"
author: "Keita Iida"
date: "`r Sys.Date()`"
output:
...
The data were obtained from 10x Genomics repository (PBMC 6k).
...
### Infer cell types
Defining significant genes as genes with sc3_4_de_padj<1e-100,
infer cell types using [GeneCards](https://www.genecards.org/).
```
