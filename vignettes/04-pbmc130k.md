...
-   [4 Prepare scRNA-seq data](#4-prepare-scrna-seq-data)
    -   [4.1 PBMCs with and without sepsis (Reyes et
        al., 2020)](#41-pbmcs-with-and-without-sepsis-reyes-et-al-2020)
...
Defining significant genes as genes with sc3\_7\_de\_padj&lt;1e-80,
