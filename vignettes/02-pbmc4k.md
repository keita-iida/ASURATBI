...
p <- ggplot2::ggplot() +
  ...
  ggplot2::theme(plot.title = ggplot2::element_text(hjust = 0.5, size = 18)) +
  ggplot2::guides(colour = ggplot2::guide_legend(override.aes = list(size = 4)))
filename <- "figures/figure_04_0299.png"
ggplot2::ggsave(file = filename, plot = p, dpi = 50, width = 5.1, height = 4.3)
...
<img src="figures/figure_04_0299.png" width="200px">

``` r
# Save data.
saveRDS(pbmcs, file = "backup/04_025_pbmc4k_asurat_msigdb.rds")

# Load data.
pbmcs <- readRDS("backup/04_025_pbmc4k_asurat_msigdb.rds")
```
