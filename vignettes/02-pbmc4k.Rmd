---
title: "Analysis of 10x PBMC 4k dataset"
author: "Keita Iida"
date: "`r Sys.Date()`"
output:
...
obtained from peripheral blood mononuclear cells (PBMCs) of healthy donors.
...
The data were obtained from 10x Genomics repository (PBMC 4k).
...
**Tips:**
As mentioned in Cruz and Wishart, Cancer Inform. 2, 59-77 (2006), highly
variable genes are selected as the cell-per-variable gene ratio being 5:1.
```{r, eval = FALSE}
...
### Infer cell types
Defining significant genes as genes with sc3_8_de_padj<1e-100,
infer cell types using [GeneCards](https://www.genecards.org/).
```
